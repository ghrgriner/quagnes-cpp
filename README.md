...
starting at 1 and M = floor(N/1000). See [Program Input and Output](Program-Input-and-Output#program-input)
...
(`rc=3`). See [Program Input and Output](Program-Input-and-Output#program-output)
